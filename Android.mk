...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += $(USER_CFLAGS) -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"AnyMiss"' -DVERSION='"1.0.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
